...
class Pose extends AiModel {
  ...
  Future<void> loadModel() async {
    try {
      print('successsssssssssssssssssssss1');
      final interpreterOptions = InterpreterOptions();
      print('successsssssssssssssssssssss2');
      interpreter ??= await Interpreter.fromAsset(ModelFile.pose,
          options: interpreterOptions);
      print('successsssssssssssssssssssss3');
      final outputTensors = interpreter!.getOutputTensors();
      print('successsssssssssssssssssssss4');
      ...
      print('aaaaaaaaaError while creating interpreter: $e');
    }
  }
